 ...
 * @author Dell
 */
public class ContMenu extends javax.swing.JFrame {

    /**
     * Creates new form ContMenu
     */
    public ContMenu() {
        initComponents();
        ...
        try {
                ...
                if ( !rs.isBeforeFirst() ) 
                {    
                    JOptionPane.showMessageDialog(null,"CONTINENTAL MENU IS EMPTY !","ERROR!",JOptionPane.ERROR_MESSAGE);
                } 
                else
                {   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
